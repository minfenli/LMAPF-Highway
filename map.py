...
def main():
    ...
    parser.add_argument("--agent_num", type= int, default= 53, help="number of agents")
    parser.add_argument("--warehouse_form", type= str2bool, default=True, help="form like warehouse, not care loops")
    parser.add_argument("--line_num", type= int, default= 2, help="number of corridors in a single column or row")

...
class PBS:
    ...
    def search_set(self, agents, time_limit=600, return_info=False):
        reach_nodes = 0
        expand_nodes = 0
...
def main():
    ...
    BUFFER_SIZE = 5
    ITERATIONS = 50
    pbs = PBS(map, WINDOW_SIZE, BUFFER_SIZE, args.use_manhat, corridors if args.use_highway_heuristic else [], args.highway_heuristic_setup)
